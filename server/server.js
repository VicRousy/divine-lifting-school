...
app.post('/api/send-welcome-email', async (req, res) => {
  const { userEmail, uniqueId, password, accountType } = req.body;
  ...
  const accountTypeText = accountType === 'admin' ? 'Administrator' : 'Teacher';

  const mailOptions = {
    from: `Divine Lifting School <${process.env.GMAIL_USER}>`,
    to: userEmail,
    subject: 'Welcome to Divine Lifting School - Your Login Credentials',
    html: `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="instructions">
            <h3>How to Login:</h3>
            <ol>
              <li>Go to the Divine Lifting School portal</li>
              <li>Enter your <strong>Login ID</strong> (not your email address)</li>
              <li>Enter your password</li>
              <li>Click "Login"</li>
            </ol>
          </div>
          
          <p>If you have any issues, please contact the school administrator.</p>
