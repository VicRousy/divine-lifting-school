...
export default function FeeManagement({ showToast, requireReAuth }: FeeManagementProps) {
  ...
  const doMarkAsPaid = async (paymentId: number) => {
  ...
  const doDeletePayment = async (paymentId: number) => {
